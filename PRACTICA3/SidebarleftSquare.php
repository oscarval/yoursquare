...
echo     "<h3 class='title-sidebar-left'>Herramientas</h3>";
echo      "<button class='guardar' onclick='javascript:location.href='create_square_guardar.html''>Guardar Square</button>";
echo    "<ul id='herramientas'>
        <li>
...
echo       "<ul>
            <li>
              ...
              <select id='fondo-background-square' onchange='javascript:location.href='create_square_bosque.html''>
                ...
                <option value='montanas.css'>Monta�as</option>
